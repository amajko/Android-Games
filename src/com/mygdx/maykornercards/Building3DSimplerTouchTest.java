...
public class Building3DSimplerTouchTest extends ApplicationAdapter implements InputProcessor {
...
/*
        ...
        config.height = 720;
        config.useHDPI = true;
        new LwjglApplication(new Building3DSimplerTouchTest(), config);
*/


        new Building3DSimplerTouchTest();
    }
